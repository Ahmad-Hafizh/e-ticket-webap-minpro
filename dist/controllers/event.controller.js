            ...
            const organizerCoupon = yield tx.organizerCoupon.create({
              data: {
                organizer_coupon_code:
                  organizerCouponInput.organizer_coupon_code,
                organizer_id:
          ...
          __awaiter(this, void 0, void 0, function* () {
            ...
            const eventLoc = yield tx.event_Location.update({
              ...
              data: {
                ...
                zipcode:
                  ...
                  checkEventExist.event_location.zipcode,
              },
            });
            //Update Event
            const event = yield tx.event.update({
              ...
              data: {
                ...
                startDate:
                  new Date(eventTimeDate.startDate) ||
                  checkEventExist.startDate,
                endDate:
                  new Date(eventTimeDate.endDate) || checkEventExist.endDate,
                ...
                event_location_id:
                  eventLoc.event_location_id ||
                  checkEventExist.event_location_id,
              },
            });
            //Update Ticket
            if (ticketTypes) {
