...
class TransactionController {
  generateTransactionAndDetails(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const transaction = yield prisma_1.prisma.$transaction((tx) =>
          __awaiter(this, void 0, void 0, function* () {
            ...
            const createdTransactionDetails =
              yield tx.transaction_Detail.findMany({
                where: {
              ...
              where: {
                transaction_details_id: {
                  in: createdTransactionDetails.map(
                    (value) => value.transaction_details_id
                  ),
                },
              },
        ...
        console.log(error);
        return responseHandler_1.default.error(
          res,
    ...
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const transactionDetails =
          yield prisma_1.prisma.transaction_Detail.findMany({
            where: { user_id: userId },
          });
        return responseHandler_1.default.success(
          res,
  ...
  paidTransaction(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const updateTransaction = yield prisma_1.prisma.$transaction((tx) =>
          __awaiter(this, void 0, void 0, function* () {
            ...
            ticket.map((value, index) =>
              __awaiter(this, void 0, void 0, function* () {
                ...
                const updateTicket = yield prisma_1.prisma.$transaction((tx) =>
                  __awaiter(this, void 0, void 0, function* () {
                    ...
                    console.log(
                      "Ini value quantity bought: ",
                      value.quantityBought
                    );
                    console.log(
                      "Ini value quantity available: ",
                      checkTicketTypes === null || checkTicketTypes === void 0
                        ? void 0
                    ...
                    if (organizerCouponId && organizerCouponId > 0) {
                      const updateOrganizerCoupon =
                        yield tx.organizerCoupon.update({
                          where: {
  ...
  generateProofPayment(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const { secure_url } = yield (0, cloudinary_1.cloudinaryUpload)(
          req.file,
          "proofOfPayment"
        );
  ...
  getTransactionbyOrganizer(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        const userId = res.locals.dcrypt.user_id;
        const response = yield prisma_1.prisma.$transaction((tx) =>
          __awaiter(this, void 0, void 0, function* () {
